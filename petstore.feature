...
Background: Base url 
    ...
    And path "user"
    * def userId = "13"
    * def userName = "kamillyt"
    * def userNameUpdate = "elidag"
    * def payload = { id: 13, username: "kamillyt", firstName: "Kamilly", lastName: "Tiburtino", email: "kamillyt@example.com", password: "1234", phone: "9999-9999", userStatus: 0 }
    * def payloadUpdate = { id: 14, username: "elidag", firstName: "Kamilly", lastName: "Tiburtino", email: "kamillyt@example.com", password: "4321", phone: "8888-8888", userStatus: 0 }
